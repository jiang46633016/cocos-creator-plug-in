...
module.exports = {
    ...
    replaceFileUuid: function (json) {
        if (json && typeof json == "object") {
            ...
            //检查componentId
            var componentId = json['_componentId'];
            if (componentId && uuidUtils.isUuid(componentId)) {
                if (Reg_Uuid.test(componentId)) {
                    if (uuidMap[componentId]) {
                        json['_componentId'] = uuidMap[componentId].uuid;
                    }
                } else {
                    var de_componentId = uuidUtils.decompressUuid(componentId);
                    if (uuidMap[de_componentId]) {
                        json['_componentId'] = uuidUtils.compressUuid(uuidMap[de_componentId].uuid, false);
                    }
                }
            }
